...
describe MarkLogic::Queries::AndQuery do
  ...
  describe "#to_s" do
    it "should create xquery correctly" do
      ...
      expect(q.to_s).to eq(%Q{cts:and-query(())})
    end
    ...
    it "should create xquery correctly" do
      ...
      expect(q.to_s).to eq(%Q{cts:and-query((cts:directory-query(("/foo/"))))})
    end
    ...
    it "should create xquery correctly" do
      ...
      expect(q.to_s).to eq(%Q{cts:and-query((cts:directory-query(("/foo/")),cts:directory-query(("/bar/"))))})
    end
  end
end
