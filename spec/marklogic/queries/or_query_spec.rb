...
describe MarkLogic::Queries::OrQuery do
  ...
  describe "to_s" do
    it "should create json correctly" do
      ...
      expect(q.to_s).to eq(%Q{cts:or-query(())})
    end
    ...
    it "should create json correctly" do
      ...
      expect(q.to_s).to eq(%Q{cts:or-query((cts:directory-query(("/foo/"))))})
    end
    ...
    it "should create json correctly" do
      ...
      expect(q.to_s).to eq(%Q{cts:or-query((cts:directory-query(("/foo/")), cts:directory-query(("/bar/"))))})
    end
